...
export function MovieCard({ title, year, genre, rating, description, poster }: Movie) {
  ...
  return (
    <>
      <div className={styles['movie-card']} onClick={() => setIsModalOpen(true)}>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className={styles['movie-card__modal-content']}>
          ...
          <div className={styles['movie-card__modal-main']}>
            <h2 className={styles['movie-card__modal-title']}>{title}</h2>
